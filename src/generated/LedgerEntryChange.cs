...
public class LedgerEntryChange {
  ...
  public LedgerEntry Created { get; set; } = default(LedgerEntry);
  public LedgerEntry Updated { get; set; } = default(LedgerEntry);
  public LedgerKey Removed { get; set; } = default(LedgerKey);
  public LedgerEntry State { get; set; } = default(LedgerEntry);
