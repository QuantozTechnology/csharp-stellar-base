...
public class LedgerUpgrade {
  ...
  public Uint32 NewLedgerVersion { get; set; } = default(Uint32);
  public Uint32 NewBaseFee { get; set; } = default(Uint32);
  public Uint32 NewMaxTxSetSize { get; set; } = default(Uint32);
