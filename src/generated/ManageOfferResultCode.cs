...
public class ManageOfferResultCode {
  ...
  public ManageOfferResultCodeEnum InnerValue { get; set; } = default(ManageOfferResultCodeEnum);

  public static ManageOfferResultCode Create(ManageOfferResultCodeEnum v)
  {
    return new ManageOfferResultCode {
      InnerValue = v
    };
  }
