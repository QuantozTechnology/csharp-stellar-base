...
public class StellarMessage {
  ...
  public Error Error { get; set; } = default(Error);
  public Hello Hello { get; set; } = default(Hello);
  public Auth Auth { get; set; } = default(Auth);
  public DontHave DontHave { get; set; } = default(DontHave);
  public PeerAddress[] Peers { get; set; } = default(PeerAddress[]);
  public Uint256 TxSetHash { get; set; } = default(Uint256);
  public TransactionSet TxSet { get; set; } = default(TransactionSet);
  public TransactionEnvelope Transaction { get; set; } = default(TransactionEnvelope);
  public Uint256 QSetHash { get; set; } = default(Uint256);
  public SCPQuorumSet QSet { get; set; } = default(SCPQuorumSet);
  public SCPEnvelope Envelope { get; set; } = default(SCPEnvelope);
  public Uint32 GetSCPLedgerSeq { get; set; } = default(Uint32);
